...
int parse_arguments(int argc, char *argv[]) {
	...
	std::cerr << "\t`./bin/base <file_name> -q`, to perform preprocessing on the input and print the preprocessed file to stdout\n";
	return ARG_FAIL;
}
